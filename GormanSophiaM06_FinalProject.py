...
#or losing, and obtaining a regular 6-star character.
...
if pity == "win":
    if chance >= 75:
        print("You will get a regular 6-star character within the next 15 wishes. You still need another 75-90 wishes to obtain the banner character.")
    elif chance < 75:
        chance = 75 - chance
        print("You still need ", chance, " wishes to get into the pity draw to obtain a 6-star character. Afterwards, it will take you another 75-90 wishes to obtain the banner character. Good luck!")
    else:
        print("Invalid. Please try again")

#These functions tell the user how many more wishes they need to obtain a 6-star character, whether banner or regular